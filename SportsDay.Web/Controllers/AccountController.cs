...
namespace SportsDay.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private async Task AssignRolesBasedOnConfigurationAsync(IdentityUser user, string email)
        {
            try
            {
                var adminEmails = _configuration.GetSection("SportsDayManager:DefaultAdminEmails").Get<string[]>();
                var judgeEmails = _configuration.GetSection("SportsDayManager:DefaultJudgeEmails").Get<string[]>();
                var scorekeeperEmails = _configuration.GetSection("SportsDayManager:DefaultScorekeeperEmails").Get<string[]>();
